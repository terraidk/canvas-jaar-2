    ...
    <navbar>
        ...
        if (isset($_SESSION["loggedInUser"])) { // Check if the user is not logged in
            ...
            <ul>
                ...
                <li class="login"><a class="login-a" href="inloggen.php">LOGIN</a></li>
            </ul>
            <?php
        } else {
            ?>
            <ul class="boxlog" id="boxlog">
                ...
                <li class="ingelogd">
                    ...
                    <img src="userpfp.png" alt="Profile" class="profile-picture">

                    <!-- Display Dropdown -->
                    <ul class="dropdown">
                        <li class="dropdown-item"><a href="#">Proflile</a></li>
                        <li class="dropdown-item"><a href="#">Change Password</a></li>
                        <li class="dropdown-item"><a href="?uitloggen">Logout</a></li>
                    </ul>
                </li>
            </ul>
            <?php
